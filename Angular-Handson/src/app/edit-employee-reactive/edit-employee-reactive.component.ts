...
export class EditEmployeeReactiveComponent implements OnInit {
  employee: Employee = { id: 1, name: "Ramya", salary: 20000, department: { id: 1, name: "ADM" }, permanent: true, Skills: [{ id: 1, name: "HTML" }, { id: 2, name: "JAVA " }] };
  public departments = [{ id: 1, name: 'payroll' }, { id: 2, name: 'Development' }, { id: 3, name: "HR" }]

  employeeForm = this.fb.group({
    id: ['', Validators.required], name: ['', Validators.required], salary: [], permanent: [true], department: [''],
